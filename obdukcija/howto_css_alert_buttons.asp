...
<title>How To Create Alert Buttons</title>
<meta charset="utf-8">
...
.button2 {background-color: #2196F3;} /* Blue */
.button2:hover {
  background:#0b7dda
}
...
.button5 {background-color: #ff9800;} /* orange */
.button5:hover {
  background:#e68a00
}

</style>
<link rel='canonical' href='https://www.w3schools.com/howto/howto_css_alert_buttons.asp' />
...
<script type="text/javascript">var ezouid = "1770313255";</script><base href="https://www.w3schools.com/howto/howto_css_alert_buttons.asp"><script type='text/javascript'>
...
<!--{jquery}-->
<!-- END EZHEAD -->
<script type="text/javascript" data-cfasync="false">var _ezaq = {"ab_test_id":"mod1","ab_test_val":"","adgroup_rank_id":-1,"browser":"Chrome","browser_version":49,"country":"BA","device_height":528,"device_width":1280,"domain_id":34890,"engaged_time_visit":0,"forensiq_score":-1,"form_factor_id":1,"ip":"213.196.96.220","landing_page_url":"https://www.w3schools.com/tags/tag_thead.asp","os":"Windows","page_ad_positions":"","page_view_id":"dbe7a4f8-c103-46cf-460a-4767ebda51ad","pv_event_count":0,"referrer_id":0,"referring_domain":"googlesyndication.com","region":"us-east-1","serverid":"54.225.50.131:28181","t_epoch":1490174428,"template_id":126,"time_on_site_visit":0,"url":"https://www.w3schools.com/howto/howto_css_alert_buttons.asp","user_agent":"Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.112 Safari/537.36","user_id":1770313255,"visit_id":889803045,"visit_uuid":"c3974330-9579-495d-7215-ccd659898c69"};var _ezExtraQueries = "&ez_orig=1";</script><script data-cfasync='false' type="text/javascript" src="/ezoic/impt.js?cb=150-3&v=10" async></script></head>
<body>
...
<a target="_top" href="howto_css_image_overlay.asp">Image Overlay</a>
...
<a target="_top" href="howto_css_next_prev.asp">Next/prev</a>
...
<a target="_top" href="howto_website.asp">Web Site 2016</a>
...
<a target="_top" href="howto_js_sort_list.asp">Sort HTML List</a>
<a target="_top" href="howto_js_sort_table.asp">Sort HTML Table</a>
...
<h1>How TO - Alert Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_calendar.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_animate_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style "alert" buttons with CSS.</p>
<hr>

<button class="button">Success</button>
<button class="button button2">Info</button>
<button class="button button5">Warning</button>
<button class="button button3">Danger</button>
<button class="button button4">Default</button>
<br>

<hr>

<h2>How To Style Alert Buttons</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button class=&quot;btn success&quot;&gt;Success&lt;/button&gt;<br>&lt;button class=&quot;btn 
  info&quot;&gt;Info&lt;/button&gt;<br>&lt;button class=&quot;btn warning&quot;&gt;Warning&lt;/button&gt;<br>&lt;button 
  class=&quot;btn danger&quot;&gt;Danger&lt;/button&gt;<br>&lt;button class=&quot;btn 
  default&quot;&gt;Default&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .btn {<br>&nbsp;&nbsp;&nbsp; border: none; /* Remove borders */<br>&nbsp;&nbsp;&nbsp; color: white; 
  /* Add a text color */<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 28px; /* Add some padding */<br>&nbsp;&nbsp;&nbsp; cursor: pointer; 
  /* Add a pointer cursor on mouse-over */<br>}<br><br>.success {background-color: #4CAF50;} /* 
  Green */<br>.success:hover {background-color: #46a049;}<br><br>.info 
  {background-color: #2196F3;} /* Blue */<br>.info:hover 
  {background: #0b7dda;}<br><br>.warning {background-color: #ff9800;} /* Orange */<br>.warning:hover 
  {background: #e68a00;}<br><br>.danger {background-color: #f44336;} /* Red */
  <br>.danger:hover {background: #da190b;}<br><br>.default {background-color: 
  #e7e7e7; color: black;} /* Gray */ <br>.default:hover {background: #ddd;}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_alert_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<p>Go to our <a href="/css/css3_buttons.asp">CSS Buttons Tutorial</a> to learn 
more about how to style buttons.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_calendar.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_animate_buttons.asp">Next &#10095;</a>
...
<![endif]-->
<script type='text/javascript' src='//www.w3schools.com/utilcave_com/inc/ezf-min.php?a=a&cb=3&shcb=9' style='display:none;' async></script>
</body>
</html>
